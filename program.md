...
2. peak memory in GB, round to .1f (e.g. 12.3 — divide peak_vram_mb by 1024) — use 0.0 for crashes
...
```
val_bpb	memory_gb	status	description
0.997900	44.0	keep	baseline
0.993200	44.2	keep	increase LR to 0.04
1.005000	44.0	discard	switch to GeLU activation
0.000000	0.0	crash	double model width (OOM)
```

## The experiment loop

The experiment runs on master branch
